import { S as Span, T as Trace, a as SpanType, D as Dataset, b as DatasetItemData, O as OpikClient } from './Client-DZhX83gv.js';
export { d as DatasetPublic, c as OpikConfig, P as Prompt, e as PromptType } from './Client-DZhX83gv.js';
...
declare const validationSchema$3: z$1.ZodObject<{
...
type Input$3 = z$1.infer<typeof validationSchema$3>;
/**
...
declare const validationSchema$2: z$1.ZodObject<{
...
type Input$2 = z$1.infer<typeof validationSchema$2>;
/**
...
declare const validationSchema: z$1.ZodObject<{
    output: z$1.ZodUnknown;
}, "strip", z$1.ZodTypeAny, {
    output?: unknown;
}, {
...
type Input = z$1.infer<typeof validationSchema>;
/**
...
export { BaseMetric, Contains, type EvaluateOptions, type EvaluationResult, type EvaluationScoreResult, type EvaluationTask, type EvaluationTestCase, type EvaluationTestResult, ExactMatch, type FilterExpression, IsJson, OpikClient as Opik, OpikQueryLanguage, SpanType as OpikSpanType, RegexMatch, type ScoringKeyMappingType, Span, SpanType, Trace, disableLogger, evaluate, flushAll, generateId, getTrackContext, logger, setLoggerLevel, track };
